...
# 2.1 [xray-core] bin, latest release
elif [ "${1}" = "xray" ]; then
...
# 2.2 [xray-core] bin, user specified release
...
# 2.3 [sing-box] bin, latest release
...
# 2.4 [sing-box] bin, user specified release
...
# 2.5 [warp-go] bin, latest release, linux, amd64
elif [ "${1}" = "warp-go" ]; then
